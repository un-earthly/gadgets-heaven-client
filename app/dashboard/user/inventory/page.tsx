    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Real-time stock levels and warehouse status</p>
        </div>
            ...
            <div className="flex gap-2">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="w1">New York</SelectItem>
                  <SelectItem value="w2">Los Angeles</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
