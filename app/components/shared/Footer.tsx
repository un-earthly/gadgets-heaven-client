...
const Footer = () => {
    return (
        <footer className="bg-orange-100 text-orange-400 py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Email: info@gadgetsheaven.com</p>
                    </div>
                    <div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-700 text-center">
                    <p className="text-gray-400">&copy; {new Date().getFullYear()} Gadgets Heaven. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
