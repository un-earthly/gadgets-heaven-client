...
export default function HomeBanner() {
    return (
        <div className='md:px-24 min-h-[90vh] bg-white'>
            <div className="flex items-center justify-center flex-col xl:flex-row p-4">
                <div className='space-y-6'>
                    <h1 className="md:text-4xl text-xl text-center font-semibold"> Welcome To Gadgets Heaven</h1>
                    ...
                    <Link to='/contact'><Button btnText='Lets Have A Chat' classes="border-cyan-400 hover:bg-cyan-400 text-cyan-400 w-3/4 ml-auto mt-5 block" /></Link>
                </div>
